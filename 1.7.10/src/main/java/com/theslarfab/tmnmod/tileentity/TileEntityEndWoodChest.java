package com.theslarfab.tmnmod.tileentity;
...
public class TileEntityEndWoodChest extends TileEntity implements IInventory {
	private ItemStack[] chestContents = new ItemStack[36];
	/** Determines if the check for adjacent chests has taken place. */
	public boolean adjacentChestChecked;
	/** Contains the chest tile located adjacent to this one (if any) */
	public TileEntityEndWoodChest adjacentChestZNeg;
	/** Contains the chest tile located adjacent to this one (if any) */
	public TileEntityEndWoodChest adjacentChestXPos;
	/** Contains the chest tile located adjacent to this one (if any) */
	public TileEntityEndWoodChest adjacentChestXNeg;
	/** Contains the chest tile located adjacent to this one (if any) */
	public TileEntityEndWoodChest adjacentChestZPos;
	...
	public TileEntityEndWoodChest() {
		this.cachedChestType = -1;
	}

	@SideOnly(Side.CLIENT)
	public TileEntityEndWoodChest(int p_i2350_1_) {
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.customName : "container.end_wood_chest";
	}
	...
	private void func_145978_a(TileEntityEndWoodChest p_145978_1_, int p_145978_2_) {
	...
	public void checkForAdjacentChests() {
		if (!this.adjacentChestChecked) {
			...
			if (this.func_145977_a(this.xCoord - 1, this.yCoord, this.zCoord)) {
				this.adjacentChestXNeg = (TileEntityEndWoodChest) this.worldObj.getTileEntity(this.xCoord - 1, this.yCoord,
						this.zCoord);
			}

			if (this.func_145977_a(this.xCoord + 1, this.yCoord, this.zCoord)) {
				this.adjacentChestXPos = (TileEntityEndWoodChest) this.worldObj.getTileEntity(this.xCoord + 1, this.yCoord,
						this.zCoord);
			}

			if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord - 1)) {
				this.adjacentChestZNeg = (TileEntityEndWoodChest) this.worldObj.getTileEntity(this.xCoord, this.yCoord,
						this.zCoord - 1);
			}

			if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord + 1)) {
				this.adjacentChestZPos = (TileEntityEndWoodChest) this.worldObj.getTileEntity(this.xCoord, this.yCoord,
						this.zCoord + 1);
			}
	...
	private boolean func_145977_a(int p_145977_1_, int p_145977_2_, int p_145977_3_) {
		if (this.worldObj == null) {
			...
			return block instanceof BlockEndWoodChest && ((BlockEndWoodChest) block).field_149956_a == this.func_145980_j();
		}
	}
	...
	public void closeInventory() {
		if (this.getBlockType() instanceof BlockEndWoodChest) {
			--this.numPlayersUsing;
			this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType(), 1,
					this.numPlayersUsing);
			this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType());
	...
	public int func_145980_j() {
		if (this.cachedChestType == -1) {
			if (this.worldObj == null || !(this.getBlockType() instanceof BlockEndWoodChest)) {
				return 0;
			}

			this.cachedChestType = ((BlockEndWoodChest) this.getBlockType()).field_149956_a;
		}
