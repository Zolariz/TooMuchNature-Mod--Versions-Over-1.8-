...
public class BlockTMNLeaf1 extends BlockTMNLeaves {

	public static final String[][] leaftypes = new String[][] { { "leaves_red_oak" }, { "leaves_red_oak_opaque" } };
	public static final String[] leaves = new String[] { "red_oak" };

	public BlockTMNLeaf1(Material leaves) {
		super();
	}
