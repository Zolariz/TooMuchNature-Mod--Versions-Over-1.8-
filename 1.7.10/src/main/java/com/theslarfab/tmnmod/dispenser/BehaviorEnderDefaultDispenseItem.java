package com.theslarfab.tmnmod.dispenser;
...
public class BehaviorEnderDefaultDispenseItem implements IBehaviorDispenseItem {
	...
	public final ItemStack dispense(IBlockSource p_82482_1_, ItemStack p_82482_2_) {
		...
		this.spawnDispenseParticles(p_82482_1_, BlockEnderDispenser.func_149937_b(p_82482_1_.getBlockMetadata()));
		return itemstack1;
	}
	...
	protected ItemStack dispenseStack(IBlockSource p_82487_1_, ItemStack p_82487_2_) {
		EnumFacing enumfacing = BlockEnderDispenser.func_149937_b(p_82487_1_.getBlockMetadata());
		IPosition iposition = BlockEnderDispenser.func_149939_a(p_82487_1_);
