...
public class EnderWorkbenchCraftingManager {
	/** The static instance of this class */
	private static final EnderWorkbenchCraftingManager instance = new EnderWorkbenchCraftingManager();
	 ...
	 */
	public static final EnderWorkbenchCraftingManager getInstance() {
		/** The static instance of this class */
		return instance;
	}

	private EnderWorkbenchCraftingManager() {

		recipes = new ArrayList();

		Collections.sort(this.recipes, new EnderWorkbenchRecipeSorter(this) {
	...
	public EnderWBShapedRecipes addRecipe(ItemStack itemstack, Object... p_92103_2_) {
		String s = "";
		int i = 0;
		int j = 0;
		int k = 0;
		...
		EnderWBShapedRecipes shapedrecipes = new EnderWBShapedRecipes(j, k, aitemstack, itemstack);
