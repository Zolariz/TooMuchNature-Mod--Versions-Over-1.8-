...
public class EnderWBShapedRecipes implements IRecipe {
	...
	public EnderWBShapedRecipes(int p_i1917_1_, int p_i1917_2_, ItemStack[] p_i1917_3_, ItemStack p_i1917_4_) {
	...
	public EnderWBShapedRecipes func_92100_c() {
