...
public class BlockEnderstoneTorch extends BlockTorch {
	...
	private boolean func_150111_a(World p_150111_1_, int p_150111_2_, int p_150111_3_, int p_150111_4_,
		...
		if (p_150111_5_) {
			list.add(new BlockEnderstoneTorch.Toggle(p_150111_2_, p_150111_3_, p_150111_4_,
		...
		for (int i1 = 0; i1 < list.size(); ++i1) {
			BlockEnderstoneTorch.Toggle toggle = (BlockEnderstoneTorch.Toggle) list.get(i1);
	...
	public BlockEnderstoneTorch(boolean isLit) {
		this.isLit = isLit;
	...
	public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_) {
		...
		while (list != null && !list.isEmpty()
				&& p_149674_1_.getTotalWorldTime() - ((BlockEnderstoneTorch.Toggle) list.get(0)).field_150844_d > 60L) {
			list.remove(0);
		}
	...
	public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_,
		...
		if (!this.func_150108_b(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, p_149695_5_)) {
			...
			if (this.isLit && flag || !this.isLit && !flag) {
