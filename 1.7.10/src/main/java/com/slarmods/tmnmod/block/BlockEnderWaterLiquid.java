...
public abstract class BlockEnderWaterLiquid extends Block {
	@SideOnly(Side.CLIENT)
	private IIcon[] iconLiquid;

	protected BlockEnderWaterLiquid(Material material) {
		super(material);
		float f = 0.0F;
		float f1 = 0.0F;
	...
	public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
		return p_149691_1_ != 0 && p_149691_1_ != 1 ? this.iconLiquid[1] : this.iconLiquid[0];
	}
	...
	protected int func_149804_e(World p_149804_1_, int p_149804_2_, int p_149804_3_, int p_149804_4_) {
		return p_149804_1_.getBlock(p_149804_2_, p_149804_3_, p_149804_4_).getMaterial() == this.blockMaterial
				? p_149804_1_.getBlockMetadata(p_149804_2_, p_149804_3_, p_149804_4_) : -1;
	}
	...
	public boolean isBlockSolid(IBlockAccess blockAccess, int x, int y, int z, int side) {
		...
		return material == this.blockMaterial ? false
				: (side == 1 ? true
						: (material == Material.ice ? false : super.isBlockSolid(blockAccess, x, y, z, side)));
	}
		...
		for (int i1 = 0; i1 < 4; ++i1) {
			...
			if (l1 < 0) {
				if (!p_149800_1_.getBlock(j1, p_149800_3_, k1).getMaterial().blocksMovement()) {
					...
					if (l1 >= 0) {
						i2 = l1 - (l - 8);
						vec3 = vec3.addVector((double) ((j1 - p_149800_2_) * i2),
								(double) ((p_149800_3_ - p_149800_3_) * i2), (double) ((k1 - p_149800_4_) * i2));
					}
				}
			} else if (l1 >= 0) {
				i2 = l1 - l;
				vec3 = vec3.addVector((double) ((j1 - p_149800_2_) * i2), (double) ((p_149800_3_ - p_149800_3_) * i2),
						(double) ((k1 - p_149800_4_) * i2));
			}
		}
