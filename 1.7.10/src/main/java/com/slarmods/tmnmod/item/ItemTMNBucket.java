...
public class ItemTMNBucket extends Item {
	...
	public ItemTMNBucket(Block p_i45331_1_) {
		this.maxStackSize = 1;
			...
			if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
				...
				if (flag) {
					...
					if (material == Material.water && l == 0) {
						...
						return this.func_150910_a(p_77659_1_, p_77659_3_, TooMuchNature.ender_water_bucket);
					}
	...
	public boolean tryPlaceContainedLiquid(World p_77875_1_, int p_77875_2_, int p_77875_3_, int p_77875_4_) {
		if (this.isFull == Blocks.air) {
			...
			if (!p_77875_1_.isAirBlock(p_77875_2_, p_77875_3_, p_77875_4_) && !flag) {
				...
				if (p_77875_1_.provider.isHellWorld && this.isFull == TooMuchNature.ender_water_dynamic) {
